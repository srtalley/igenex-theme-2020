                ...
                <div class="content">
                  ...
                  <div class="compatible home">
                    <div class="grid-x">
                      ...
                      <?php foreach (get_field('kit_compatibility') as $key => $value) { echo "<div class='cell small-6 xlarge-4'>" . "&#10003;&nbsp;" . $value . "</div>"; } ?>
                    </div>
                  </div>
                  <div class="woo">
                      ...
                      <div class="cell large-shrink text-center large-text-left price-container">
                        <div class="price">
                          <div class="small-text-center">
                            <div>
                            <span data-tooltip aria-haspopup="true" class="has-tip top" data-allow-overlap="true" data-click-open="false" data-disable-hover="false" tabindex="1" title="This deposit covers the cost of your test kit and will be deducted from your final testing fees.">Deposit
                          		<span class="info-tip">
